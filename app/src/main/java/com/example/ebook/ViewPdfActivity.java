...
public class ViewPdfActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isConnected()) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(ViewPdfActivity.this);
            builder.setTitle("NoInternet Connection Alert")
                    ...
                    .setNegativeButton("No", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Toast.makeText(ViewPdfActivity.this,"Go Back TO HomePage!",Toast.LENGTH_SHORT).show();
                        }
                    });
            //Creating dialog box
        ...
        new ViewPdfActivity.RetrievePDFStream().execute(link);
    }
